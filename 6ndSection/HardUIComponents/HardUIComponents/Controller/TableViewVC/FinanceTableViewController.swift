...
class FinanceTableViewController: UIViewController {
    ...
    private lazy var windowTableView: UITableView = {
        ...
        window.register(FinanceCustomTableViewCell.self, forCellReuseIdentifier: FinanceCustomTableViewCell.identifier)
